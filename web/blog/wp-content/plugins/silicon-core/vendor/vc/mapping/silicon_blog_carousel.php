	...
	'params'   => silicon_vc_map_params( array(
		array(
			...
			'description' => __(
				...
				If you choose the "Posts" further you can clarify the request.',
				'silicon'
			),
		...
		array(
			...
			'description' => __(
				'You can specify post categories, tags or custom taxonomies.
				NOTE: Try to avoid using terms with the same slug.',
				'silicon'
			),
			'group'       => __( 'Query Builder', 'silicon' ),

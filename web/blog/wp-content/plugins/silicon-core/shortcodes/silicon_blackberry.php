...
$a = shortcode_atts( apply_filters( 'silicon_shortcode_default_atts', array(
	'name'      => __( 'BlackBerry World', 'silicon' ),
	'text'      => __( 'Available on', 'silicon' ),
	'link'      => '',
	'animation' => '',
	'class'     => '',
), $shortcode ), $atts );
...
/**
 * Filter the path to BlackBerry background
 *
 * @param string $path URI to background image
 */
$image = apply_filters( 'silicon_shortcode_blackberry_bg', SILICON_PLUGIN_URI . '/img/market-btns/blackberry.png' );

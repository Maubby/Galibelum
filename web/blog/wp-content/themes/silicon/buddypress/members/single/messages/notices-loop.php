		...
		<?php while ( bp_message_threads() ) : bp_message_thread(); ?>
			<tr id="notice-<?php bp_message_notice_id(); ?>" class="<?php bp_message_css_class(); ?>">
				...
				<td width="21%">
					...
					<span class="activity"><?php esc_html_e( 'Sent:', 'silicon' ); ?> <?php bp_message_notice_post_date(); ?></span>
				</td>
				...
				<td width="10%">
					<a href="<?php bp_message_activate_deactivate_link(); ?>" class="btn btn-solid btn-pill btn-default confirm"><?php bp_message_activate_deactivate_text(); ?></a>
					<a href="<?php bp_message_notice_delete_link(); ?>" class="btn btn-solid btn-pill btn-danger confirm" title="<?php esc_attr_e( "Delete Message", 'silicon' ); ?>"><?php esc_html_e( 'Delete', 'silicon' ); ?></a>
				</td>
			</tr>
		<?php endwhile; ?>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php esc_html_e( 'Sorry, no notices were found.', 'silicon' ); ?></p>
	</div>

...
<h2 class="bp-screen-reader-text"><?php
	...
	esc_html_e( 'Profile visibility settings', 'silicon' );
?></h2>
...
<form action="<?php echo trailingslashit( bp_displayed_user_domain() . bp_get_settings_slug() . '/profile' ); ?>" method="post" class="standard-form" id="settings-form">
				...
				<table class="profile-settings" id="xprofile-settings-<?php bp_the_profile_group_slug(); ?>">
					<thead>
						<tr>
							...
							<th class="title"><?php esc_html_e( 'Visibility', 'silicon' ); ?></th>
						</tr>
					</thead>
	...
	<div class="submit">
        <button id="submit" type="submit" name="xprofile-settings-submit"
                class="btn btn-solid btn-pill btn-default"
        ><?php esc_html_e( 'Save Settings', 'silicon' ); ?></button>
	</div>

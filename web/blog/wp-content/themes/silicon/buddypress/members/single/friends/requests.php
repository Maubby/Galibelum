...
<?php if ( bp_has_members( 'type=alphabetical&include=' . bp_get_friendship_requests() ) ) : ?>
	...
	<h2 class="bp-screen-reader-text"><?php
		...
		esc_html_e( 'Friendship requests', 'silicon' );
	?></h2>
	...
	<ul id="friend-list" class="item-list">
		<?php while ( bp_members() ) : bp_the_member(); ?>
			...
			<li id="friendship-<?php bp_friend_friendship_id(); ?>">
				...
				<div class="action">
					<a class="btn btn-ghost btn-pill btn-success accept" href="<?php bp_friend_accept_request_link(); ?>"><?php esc_html_e( 'Accept', 'silicon' ); ?></a>
					<a class="btn btn-ghost btn-pill btn-warning reject" href="<?php bp_friend_reject_request_link(); ?>"><?php esc_html_e( 'Reject', 'silicon' ); ?></a>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php esc_html_e( 'You have no pending friendship requests.', 'silicon' ); ?></p>
	</div>

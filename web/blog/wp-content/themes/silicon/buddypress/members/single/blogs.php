...
<div class="item-list-tabs si-bp-sub-nav" id="subnav" aria-label="<?php esc_attr_e( 'Member secondary navigation', 'silicon' ); ?>" role="navigation">
	<ul>
		...
		<li id="blogs-order-select" class="last filter">
			...
			<label for="blogs-order-by"><?php esc_html_e( 'Order By:', 'silicon' ); ?></label>
			<select id="blogs-order-by">
				<option value="active"><?php esc_html_e( 'Last Active', 'silicon' ); ?></option>
				<option value="newest"><?php esc_html_e( 'Newest', 'silicon' ); ?></option>

...
<h2 class="bp-screen-reader-text" xmlns="http://www.w3.org/1999/html"><?php
	/* translators: accessibility text */
	esc_html_e( 'Notification settings', 'silicon' );
?></h2>

<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/notifications'; ?>" method="post" class="standard-form" id="settings-form">
	<p><?php esc_html_e( 'Send an email notice when:', 'silicon' ); ?></p>

...
<h2 class="bp-screen-reader-text"><?php
	...
	esc_html_e( 'Compose Message', 'silicon' );
?></h2>
...
<form action="<?php bp_messages_form_action(); ?>" method="post" id="send_message_form" class="standard-form" enctype="multipart/form-data">
    ...
    <label for="send-to-input"><?php esc_html_e( "Send To (Username or Friend's Name)", 'silicon' ); ?></label>
	...
	<?php if ( bp_current_user_can( 'bp_moderate' ) ) : ?>
		<p><label for="send-notice"><input type="checkbox" id="send-notice" name="send-notice" value="1" /> <?php esc_html_e( "This is a notice to all users.", 'silicon' ); ?></label></p>
	<?php endif; ?>

	<label for="subject"><?php esc_html_e( 'Subject', 'silicon' ); ?></label>
	<input type="text" name="subject" id="subject" value="<?php bp_messages_subject_value(); ?>" />

	<label for="message_content"><?php esc_html_e( 'Message', 'silicon' ); ?></label>
	...
	<div class="submit">
        ...
        ><?php esc_html_e( "Send Message", 'silicon' ); ?></button>
	</div>

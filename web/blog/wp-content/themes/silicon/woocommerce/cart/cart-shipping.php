...
?>
<tr class="shipping">
	<th class="font-family-headings text-gray"><?php echo wp_kses_post( $package_name ); ?></th>
	<td data-title="<?php echo esc_attr( $package_name ); ?>">
        ...
        elseif ( ! WC()->customer->has_calculated_shipping() ) :
			echo esc_html__( 'Shipping costs will be calculated once you have provided your address.', 'silicon' );
		else :
			$message = esc_html__( 'There are no shipping methods available. Please double check your address, or contact us if you need any help.', 'silicon' );
			if ( is_cart() ) {
				echo apply_filters( 'woocommerce_cart_no_shipping_available_html', $message );
			} else {
				echo apply_filters( 'woocommerce_no_shipping_available_html', $message );
			}
			unset( $message );
		endif;

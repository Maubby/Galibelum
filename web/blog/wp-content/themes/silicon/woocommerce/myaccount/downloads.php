		...
		<thead>
			<tr>
				<?php foreach ( wc_get_account_downloads_columns() as $column_id => $column_name ) : ?>
					<th class="<?php echo esc_attr( $column_id ); ?> text-gray font-family-headings"><span class="nobr"><?php echo esc_html( $column_name ); ?></span></th>
				<?php endforeach; ?>
			</tr>
		</thead>
							...
							if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
								...
								switch ( $column_id ) {
									...
									case 'download-remaining' :
										echo is_numeric( $download['downloads_remaining'] ) ? esc_html( $download['downloads_remaining'] ) : esc_html__( '&infin;', 'silicon' );
										break;
										...
										<?php
											$actions = array(
												'download'  => array(
													...
													'name' => esc_html__( 'Download', 'silicon' ),
												),
											);
...
<?php else : ?>
	<div class="woocommerce-Message woocommerce-Message--info woocommerce-info border-color-info">
		<a class="woocommerce-Button btn btn-solid btn-info btn-pill btn-sm pull-right" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
			<?php esc_html_e( 'Go shop', 'silicon' ) ?>
		</a>
		<?php esc_html_e( 'No downloads available yet.', 'silicon' ); ?>
	</div>
<?php endif; ?>
